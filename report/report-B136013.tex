...
\section{Tools}
  ...
  \end{enumerate}
	...
	All of the results will be save in the data/ folder in different files. Once the submitted jobs are completed, a Python script is responsible to analyse the data and create the graphs. To run the script execute \Colorbox{mygray}{\lstinline|python data\_analyzer.py|}. In addition, we have created our edge files, to reproduce that run \Colorbox{mygray}{\lstinline|./converter.sh|} in converter/ folder.
