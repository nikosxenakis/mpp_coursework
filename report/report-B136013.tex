...
\section{Evaluation}
    ...
    \subsection{Performance}
        ...
        \subsubsection{Average Pixel}
        	...
        	\begin{figure}[ht]
			    \centering
				\subfloat[Average pixel for image 192x128]{{\includegraphics[width=.42\linewidth]{../graphs/edgenew192x128_average_pixel.eps} }}
			    \qquad		    
			    \subfloat[Average pixel for image 256x192]{{\includegraphics[width=.42\linewidth]{../graphs/edgenew256x192_average_pixel.eps} }}
			    \qquad
			    \subfloat[Average pixel for image 768x768]{{\includegraphics[width=.42\linewidth]{../graphs/edgenew768x768_average_pixel.eps} }}
			    \qquad
			    \subfloat[Average pixel for image 1600x1200]{{\includegraphics[width=.42\linewidth]{../graphs/edgenew1600x1200_average_pixel.eps} }}
